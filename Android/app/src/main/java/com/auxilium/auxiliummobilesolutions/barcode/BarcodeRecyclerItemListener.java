...
public class BarcodeRecyclerItemListener implements RecyclerView.OnItemTouchListener {
    ...
    public BarcodeRecyclerItemListener(Context ctx, final RecyclerView rv, final RecyclerTouchListener listener) {
